...
%TABLES
\input{config/booktabs_config}


%CUSTOM COMMANDS
\input{config/cariban_language_names.tex}
...
%HYPHENATION
\hyphenation{Wa-ya-na mar-ker Ti-ri-yó Des-mond An-tro-po-ló-gi-ca Hix-ka-ryá-na}
...
%For others
\input{config/ling_bib_conf.tex}
