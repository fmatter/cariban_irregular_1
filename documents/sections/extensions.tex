...
The goal of this section is to identify distributional patterns of innovative and conservative prefixes in the \gl{s_a_} lexicon, in order to search for potential explanations \pcref{sec:motivations}.
...
\cref{sec:waiwaian} is about the extension of \rc{k-} in \PWai, which was briefly shown in \cref{sec:extensions_intro}.
