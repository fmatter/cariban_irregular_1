...
We present them according to the phonemic analysis of \bakairi by \textcites{meira2003bakairi}{meira2005bakairi} in \exref{bakverbs}.
...
Thus, we suggest that the \ikpeng \gl{1}\gl{s_a_} marker \obj{ɨ-}/Ø is cognate with \arara \gl{1}\gl{s_a_} \obj{w(ɨ)-}, and was subject to phonological erosion of \rc{w}, a phenomenon which can also be found in other languages discussed in following sections.
...
Given that \bakairi and \ikpeng agree about both the first person prefix and the reflex of \rc{ət-}, we reconstruct two distinct first person forms, \rc{w-epɨ-} and \rc{k-ət-epɨ-}.\footnote{It may also be the case that the \PPek paradigm had a similar person-based distribution of \rc{əd-} as \arara, and \bakairi and \ikpeng both independently regularized the paradigm to show \rc{əd-epɨ} with all persons. If that were the case, the connection between \rc{k-} and \rc{əd-epɨ} would still exist.}
