...
While there are reflexes of \rc{a[p]} \qu{to be} in \ikpeng, only \rc{eti} forms are attested with first person inflectional prefixes \parencite[401]{gildea2018reconstructing}.
...
%\xe
%
While clearly not a regular sound change, \PXin \rc{w} is attested as sometimes being lost in \ikpeng, as evidenced by the correspondences in \cref{tab:pxinw}.
...
There are three more verbs which did not take innovative \rc{k-} in \PWai; they are shown along with \rc{ka} \qu{to say} in \cref{tab:pwaiverbs}.
