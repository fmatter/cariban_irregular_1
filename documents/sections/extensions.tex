...
We discuss each extension separately, contrasting regular and innovative verbs with irregular and conservative verbs, and reconstructing forms where necessary:
...
Further, while there are reflexes of \rc{a[p]} \qu{to be} in \ikpeng, it seems that only reflexes of \rc{eti} occur with first person inflectional prefixes \parencite[401]{gildea2018reconstructing}.
