...
He also suggests that \obj{k-} might be more recent, which is plausible: since the distribution \envr{\rc{t-}}{\obj{ə}} / \envr{\rc{t͡ʃ-}}{\obj{e}} is reconstructible to \PTir, the most straightforward scenario is \obj{k-} replacing \rc{t-} but not \rc{t͡ʃ-} in \akuriyo.
...
Based on other C-initial verbs like \obj{tə} \qu{to go} or \obj{tuda} \qu{to arrive}, one would expect \obj{ka} \qu{to say} to either have conservative \obj{wɨ-} or innovative \obj{ji-}, so the zero needs explanation.
