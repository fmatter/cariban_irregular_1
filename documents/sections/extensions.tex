...
Similarly, the change of \rc{wɨ} to \bakairi \obj{u} is found in other correspondences: \obj{udo} \parencite{meira2005southern} from \PC \rc{wɨtoto} \qu{person} \parencite[4]{gildea2007greenberg}.
...
The two forms for \qu{to be} are straightforwardly reconstructible, whereas \qu{to go} is a special case.
...
%\xe
%
In any case, the prefix pattern in \hixka \qu{to go} clearly shows that a \PWai first person form \rc{wɨ-tom-} can be reconstructed.
