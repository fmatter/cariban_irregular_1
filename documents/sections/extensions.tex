...
\label{sec:waiwaian}
This extension led to the \hixka pattern from \cref{tab:hixintro} in \cref{sec:intro} and was one of the Parukotoan extensions discussed in \cref{sec:extensions_intro}.
