...
He faced an interesting puzzle in the \setone paradigms of \trio and \akuriyo: \PC \gl{1}>\gl{3} \rc{t-} and \gl{1}\gl{s_a_} \rc{w-} seem to have switched places.
...
%
Regarding \gl{s_a_} verbs unaffected by the spread of \rc{t-}, \textcite{meira1998proto} reconstructs the first four items in \cref{tab:ptirverbs} as taking \rc{w-} in \PTar; we offer our reconstructed \PTir forms.
