...
All three Pekodian languages have a regular \gl{1}\gl{s_a_} marker \obj{k-}, as evidenced by the paradigms in \cref{tab:pekreg}.\footnote{In \cref{tab:pekreg} and the remainder of this paper, we omit any possible TAM suffixes, since our focus lies on the prefixes and stems, and since full paradigms containing the same TAM suffix are rarely found.}
...
The \ikpeng form \obj{aran} is compatible with our reconstruction \rc{ɨtən}, when one considers that \ikpeng \obj{a} is an attested outcome of \rc{ə}.\footnote{\begin{inlinelist}
...
This created a unified \gl{1}\gl{s} category, reflected in both \hixka and \waiwai \pcref{tab:pwaireg}.
%
...
%\xe
%
Not all verbs were affected by this extension; \waiwai \obj{ka} \qu{to say} does not take \obj{kɨ-}, but rather conservative \obj{wɨ-} \exref{hixɨ.wai-108}.
...
While \hixka has the expected \obj{ɨ-}, \waiwai seems to have combined innovative \obj{k-} with the old \rc{w-}, an analysis also considered by \textcite[90]{gildea1998}.
...
Summing up, we reconstruct the four verbs \rc{et͡ʃi} and \rc{a(h)} \qu{to be}, \rc{ka(s)} \qu{to say}, and \rc{tom} \qu{to go} as preserving the old \gl{1}\gl{s_a_} marker \rc{w-} in \PWai, while the rest took on innovative \rc{k-}.
