...
As discussed in \cref{sec:extensions_intro}, the person marker extensions which did not spread through the whole lexicon all have in common that they are innovative \gl{1}\gl{s_a_} markers.
...
\cref{sec:waiwaian} takes a closer look at the extension of \rc{k-} in \PWai, which was already shown in \cref{sec:extensions_intro}.
...
We took these \arara verbs as a starting point for the other Pekodian languages, as \textcite{alves2017arara} gives the most detailed description of person markers for any language of the branch.
...
I present them according to the phonemic analysis of \bakairi by \textcites{meira2003bakairi}{meira2005bakairi} in \exref{bakverbs}.

\pex[everyglpreamble=]<bakverbs> \bakairi \parencite[][131, 397, 76, 137, 374]{von1892bakairi}
\begin{multicols}{2}
\a<bak-3>
\begingl
...
Turning to the third Pekodian language, all available descriptions of \ikpeng list \obj{k-} as the only \gl{1}\gl{s_a_} marker \parencites[55]{ikpengpacheco1997}[105]{campetela1997analise}[64]{ikpengpacheco2001}[205]{alves2013verbo}.
However, most \ikpeng cognates of the \arara verbs in \exref{arairr} actually do not take \obj{k-}, but rather \obj{ɨ-} or Ø, as shown in \exref{ikpw}.
The exception is \qu{to go}, which has \obj{k-} \exref{ikp-170}.
There is a formally identical \ikpeng cognate of \arara \obj{iptoŋ} \qu{to go down} \exref{ikp-182}, but no first person forms are attested \perscommpar{Angela Chagas}.
...
Thus, we suggest that the \ikpeng \gl{1}\gl{s_a_} marker \obj{ɨ-}/Ø is cognate with \arara \gl{1}\gl{s_a_} \obj{w(ɨ)-}, and was subject to phonological erosion of \rc{w}, a phenomenon which will also be encountered in languages discussed in following sections.
...
\Cref{tab:pekverbs} gives an overview of the first person forms of the six verbs under discussion, along with our \PPek reconstruction.
The form for \rc{ge} \qu{to say} is straightforward to reconstruct; the \bakairi change of \rc{wɨ-} to \obj{u-} is not implausible given correspondences like \bakairi \obj{udo} \parencite{meira2005southern} from \PC \rc{wɨtoto} \qu{person} \parencite[4]{gildea2007greenberg}.
...
\xe
%
Thus, it seems that there was some variation in \PPar as to whether or not the first person form of \qu{to go} was based on \rc{ətepɨ} or \rc{epɨ}.
Given that \bakairi and \ikpeng agree about both the first person prefix and the reflex of \rc{ət-}, I reconstruct two distinct first person forms, \rc{w-epɨ-} and \rc{k-ət-epɨ-}.\footnote{It may also be the case that \bakairi and \ikpeng both independently regularized the paradigm to show \rc{ədepɨ} with all persons. If that were the case, the connection between \rc{k-} and \rc{ədepɨ} would still exist.}

The forms for \qu{to go down} are again not fully cognate; \textcite{meira2005southern} make no mention of a regular correspondence between \bakairi \obj{gɨ} and \ikpeng \obj{ŋ}.
...
\end{inlinelist}.
Also, based on the fact \bakairi has generally lost much segmental material, I suggest that \bakairi \obj{gɨ} is yet another addition to a root \rc{ɨptə} or \rc{iptə}, rather than a conservative form.

The forms for \qu{to go} are all cognate, but while \arara and \bakairi point to \rc{ɨtə}, the \ikpeng form is rather divergent.
...
Six verbs can be reconstructed as having resisted this innovation, and preserving \gl{1}\gl{s_a_} \rc{w(ɨ)-} in \PPek.
For \qu{to come}, two distinct forms \rc{w-epɨ-} and \rc{k-əd-epɨ-} must be reconstructed.
...
\xe
%
The \waiwai verb \obj{ka} \qu{to say} was already shown have resisted this extension in \cref{sec:extensions_intro}, showing \obj{wɨ-}, a reflex of the \PC \gl{1}\gl{s_a_} marker \rc{w-}.
...
There are two more verbs which did not take innovative \rc{k-} in \PWai.
One of them is the copula \rc{eʃi}/\obj{a(h)}, reconstructed in \exref{parpar.parcop}.
...
Summing up, I reconstruct the three verbs \rc{et͡ʃi}/\obj{a(h)} \qu{to be}, \rc{ka(s)} \qu{to say}, and \rc{to} \qu{to go} as preserving the old \gl{1}\gl{s_a_} marker \rc{w-} in \PWai, while the rest took on innovative \rc{k-}.
...
The relevant aspect of this extension is of course that not all verbs were affected by it.
\textcite{meira1998proto} lists the four verbs in \exref{ptirw} as being reconstructible to \PTar with \rc{w-}.

\pex<ptirw> \PTir \gl{1}\gl{s_a_} \rc{w-}\\
\begin{tabular}[t]{@{}llll@{}}
& \PTir & \trio & \akuriyo\\\qu{go} & \rc{wɨ-tə(mɨ)-} & \obj{wɨ-tə(mɨ)-} & \obj{ə-təmɨ-}/\obj{wɨ-təemɨ-}  \\\qu{say} & \rc{wɨ-ka-} & \obj{wɨ-ka-} & \obj{wɨ-ka-} \\\qu{come} & \rc{w-əʔepɨ-/}\obj{w-eepɨ-} & \obj{w-əepɨ-} & \obj{Ø-eepɨ-} \\\qu{be} & \rc{w-ae-} & \obj{w-ae-} & Ø\obj{-aʔe-} \\
\end{tabular}\\
\parencites[112--115]{meira1998proto}[85]{gildea1994akuriyo}
...
For \akuriyo \qu{to go}, \textcite{gildea1994akuriyo} gives a different prefix \obj{wɨ-}, rather than \posscite{meira1998proto} \obj{ə-}.\footnote{The \akuriyo recorded by Gildea potentially has strong \trio and/or \wayana influence \parencite[253]{gildea1998}.}
The two forms can be reconciled by a specific idiosyncratic combination of sound changes:
I suggest that \obj{ə} is the outcome of the lowering of the \rc{ɨ} in the prefix \rc{wɨ-}; the same has happened to the vowel in the \gl{1+2} prefix \rc{kɨt-} \exref{exp.aku-159}.
...
This erosion is also found in the etymologically related \gl{1}>\gl{3} prefix (\getfullref{13w},  \getfullref{exp.aku-164}), as well as in other Cariban languages, like \ikpeng \pcref{sec:pekodian} or \hixka \pcref{sec:waiwaian}.
...
For \qu{to come}, a similar situation as in Pekodian is encountered, in that \trio shows a reflex of \rc{ət-epɨ}, while the \akuriyo form points to bare \rc{epɨ}.
Given that \trio, like \arara, also has forms without a reflex of \rc{ət-} \exref{tri-130}, I reconstruct both \rc{w-epɨ-} and \rc{w-əʔepɨ-} for \PTir.
...
I have only found a \trio cognate for \obj{erama} \qu{to return}, which behaves like a regular \gl{s_a_} verb in that it takes \obj{s-} \exref{akumov.tri}.
...
In summary, in \PTir{} -- at the latest -- the \PC \gl{1}>\gl{3} marker \rc{t-} was extended to \gl{1} verbs.
...
It seems to have replaced \rc{t-} only in specific places, with the two markers showing a clear phonologically conditioned distribution in the \akuriyo data available to me \parencite{gildea1994akuriyo}, with all relevant verbs shown in \Cref{tab:aku1sa}.
...
He also suggests that \obj{k-} could be more recent, with which I agree -- since phonologically distributed \rc{t-}/\rc{t͡ʃ-} is reconstructible to \PTir, a scenario whereby \obj{k-} replaces \rc{t-}, but not \rc{t͡ʃ-}, is the most straightforward.
The few \obj{t-} recorded by \textcite{meira1998proto} were then either reintroduced under \trio influence, or are the last remnants of the replacement of \rc{t-}.
...
\xe
%
Thus, also detransitivized verbs like \obj{ehɨnəhɨ} \qu{to fight}, which are \gl{s_a_} verbs in other languages, take \obj{j(i)-} \exref{car-30}.
...
\glft \qu{I almost go (but I a, not going to go).}//
\endgl
\a<car-25>
\begingl
...
Since \PC \gl{1}\gl{s_a_} \rc{w(ɨ)-} was extended to \gl{1}>\gl{3} scenarios in most languages \parencite[81--82]{gildea1998}, and since it is prone to phonological erosion across the family \pcref{sec:pekodian,sec:waiwaian,sec:akuriyo}, I argue that this zero in \gl{1}>\gl{3} scenarios is in fact the \yukpa reflex of \rc{w-}.
The same zero marking is attested for a single intransitive verb: \obj{to} \qu{to go} \exref{yuk-7}.
Since regular C-initial verbs take \obj{jɨ-}, like \qu{to sleep} in \exref{yukpaintr}, I argue that \obj{to} \qu{to go} preserved the old \gl{1}\gl{s_a_} marker \rc{w(ɨ)-}, which was lost due to phonological erosion.
