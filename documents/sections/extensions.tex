...
This resulted in a regular \gl{1}\gl{s_a_} marker of the form \envr{\rc{t͡ʃ-}}{\obj{e}}, \envr{\rc{t-}}{\obj{ə}} \pcref{tab:ptirreg}; the latter allomorph was subsequently replaced by \obj{k-} in \akuriyo \pcref{sec:akuriyo}.
...
We agree with this scenario, with the exception that \trio \obj{əepɨ} is clearly a reflex of \rc{ət-epɨ} \pcref{sec:come}, meaning that the \PTir form would have been \rc{əʔepɨ}.
...
Since there are no examples of or information about \obj{ə}-initial verbs with \obj{t-}, we cannot discuss these cases.
...
All verbs in \cref{tab:ptirverbs} above did of course not introduce \obj{k-}, either; we do not know the first-person form of the copular verb \obj{eʔi}.
...
It was not affected by the extension of \akuriyo \obj{k-}, but whether it existed when \PTir \rc{t-} was extended is unclear (see \cref{sec:godown}).

\ex<tridown> First person forms of \qu{to go down} \parencites[294]{triomeira1999}[84]{gildea1994akuriyo}\\
\begin{tabular}[t]{@{}ll@{}}
\trio & \obj{p-ɨhtə-} \\
\akuriyo & \obj{p-ɨtə-}\\
\end{tabular}
...
\input{floats/carreg}
%
Although the split-\gl{s} system has been lost entirely, former \gl{s_a_} verbs can be identified by taking a detransitivizer, like \obj{ehɨnəhɨ} \qu{to fight}, derived from \obj{hɨnəhɨ} \qu{to kill} \parencite[179]{robayo2000avance}, shown in \exref{car-30}.
...
\xe
%
In addition, the verb \obj{ka} \qu{to say} has a zero-marked first-person form \exref{car-33}.
...
Further, one may suggest the difference between C-initial \obj{ka} \qu{to say} and \obj{tə} \qu{to go} to result from the latter's earlier V-initial nature \pcref{sec:go}.
...
Thus, we conclude that the extension of \obj{j-} in \yukpa stopped short of \obj{to} \qu{to go}, which preserves a phonologically reduced reflex of \rc{wɨ-}.
