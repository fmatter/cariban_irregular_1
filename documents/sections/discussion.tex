...
%
The absence of reflexes of \detrz also has a phonological consequence: usually, \gl{s_a_} verbs begin with reflexes of \rc{ə} or \rc{e}, as noted for \arara by \textcite[153]{alves2017arara}: \dbqu{Observe que todos os 12 verbos indexados pelo morfema \obj{k-} [\gl{s_a_}] apresentam a raiz iniciada pela vogal /o/}.
...
\footnote{While there are a few \gl{s_a_} not transparently derived from transitive verbs \parencites[252]{triomeira1999}[222]{meira2000split}[30]{gildea2007greenberg}, which are not featured in \cref{tab:overview}, these are mostly \rc{ə}-initial and were likely productively derived at some point.
The verbs to which this does not apply, like \trio \obj{wa} \qu{to dance} \parencites[252]{triomeira1999}, can be analyzed as more cases of \gl{s_p_} verbs switching classes.
