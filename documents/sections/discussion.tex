...
\subsection{Possible motivations: \texorpdfstring{\posscite{bybee1985morphology}}{Bybee's} network model}
...
When considering the resistant verbs in our Cariban case, reiterated in \cref{tab:overview}, a very salient property emerges:
...
\exref{care.car-32} shows the verb \qu{to go down}, which has acquired an unexpected \obj{e} in \carijo, compare the reconstruction in \cref{tab:godown}.
