...
Reflexes of \rc{w-} in languages from different branches are illustrated in \cref{tab:participles} for participles, and in \cref{tab:nominalizations} for nominalizations.
