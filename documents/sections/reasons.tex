...
A prominent example is a network of \dbqu{strong} English verbs with \obj{strɪŋ}--\obj{strʌŋ} at the center and pairs like \obj{rɪŋ}--\obj{rʌŋ}, \obj{spɪn}--\obj{spʌn}, or \obj{stɪk}--\obj{stʌk} at its periphery.
...
Each extension affected many run-of-the-mill \gl{s_a_} verbs,%
\footnote{
...
except for the \akuriyo \obj{e}-initial verbs.
If one simulates the addition of 1'000 regularly inflected detransitivized \gl{s_a_} verbs per language -- a conservative estimate based on \posscite{courtz2008carib} \kalina dictionary -- all six explanations consistently predict the behavior of 99.99+\% verbs correctly.
...
The extension of \yukpa \obj{j-} can succinctly be characterized as affecting all vowel-initial verbs; the only attested conservative verb is C-initial \obj{to} \qu{to go}.
...
These three cases where the crude model of verb frequency arrives at incorrect predictions are found in \carijo and \yukpa, the only languages to feature innovative markers on the reflexes of \rc{eti} \qu{be-2} or \rc{a[p]} \qu{be-1}.
