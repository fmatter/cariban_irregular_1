...
Putative \PC \rc{jəpɨ} would yield \rc{epɨ} by the two widespread sound changes of \rc{ə}-umlaut after \rc{j} and \rc{j}-loss \parencite{meira2010origin}, but one would expect evidence of a sequence \rc{jə} in \yawarana, \mapoyo, or \panare \parencite{gildea2010story}.
The \kaxui form \obj{ehɨ} would also not be accounted for, as \rc{ə} was not umlauted after \rc{j} in Parukotoan \parencite[501--502]{meira2010origin}.
%
