...
\label{sec:be}
For a comprehensive comparative overview of these two roots, we refer the reader to \textcite[375--382]{gildea2018reconstructing}; we will not discuss them in detail here.
...
\cref{tab:godown} shows all attested reflexes of \rc{ɨpɨtə}, including verb class membership where applicable; parenthesized forms indicate uncertainty about cognacy status.\footnote{Our reconstruction of \PPek \rc{ɨptə} treats the additional elements found in the daughter languages as non-cognate.
