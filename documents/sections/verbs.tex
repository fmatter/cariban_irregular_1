...
However, unlike \qu{to sleep}, bare \rc{epɨ} \qu{to come} apparently already was an \gl{s_a_} verb (although its reflexes in languages with split-\gl{s} always co-occur with reflexes of \rc{ət-epɨ}).
