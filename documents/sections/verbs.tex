...
\cref{sec:godown} takes a look at \rc{ɨpɨtə} \qu{to go down}, which is resistant in \PTir and \PPek, and  \cref{sec:bathe} investigates \PPek \rc{ɨpɨ} \qu{to bathe}.
...
There are many forms going seemingly reflecting \rc{əpɨ} and \rc{epɨ}, distributed widely in the family.
...
\subsection{\qu{to bathe}}
\label{sec:bathe}
This verb resisted extensions in \PPek \pcref{sec:pekodian} and \akuriyo \cref{sec:akuriyo}.
Verbs for intransitive \qu{to bathe} are usually based on transitive verbs in Cariban languages, which are reflexes of \rc{pɨ}, or \rc{kupi} in some Venezuelan languages.
