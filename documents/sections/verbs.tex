...
Cognate segments in \cref{tab:say,tab:bathe} were aligned automatically with LingPy \parencite{lingpy268}, for easier recognition of correspondences.
%
...
At least the \trio cognate shows the same pattern, albeit inconsistently \parencite[267]{triocarlin2004}.

Comparative evidence also points to \rc{ka[ti]} \qu{to say} showing transitive traits:
...
The occurrence of \obj{-ɲe} on \obj{ka} likely led \textcite[214]{panarepayne2013} to categorize it as transitive, contrastive with the intransitive analysis by \textcite[102]{mattei1994diccionario}.
...
Additionally, languages which differentiate direct prefixes from \gl{s_a_} prefixes by the presence of \obj{i} \parencite[495]{meira2010origin} show no \obj{i} for this verb, see \exref{sayintr.aku-154} and  \textcites[294]{triomeira1999}[195]{wayanatavares2005}[288]{ikpengpacheco2001}[150]{alves2017arara}[168]{hoff1968carib}.
