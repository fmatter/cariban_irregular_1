...
The resistance against the former extension was overcome in \bakairi.
In \akuriyo, the verb already had an irregularly inflected first person form with \obj{p-}, inherited from \PTir.
...
\pex<gowhere>
\a<car-18> \carijo \parencite[][102]{guerrero2019carijo}\\
\begingl
\gla əji-wa-e j-eh-ɨ//
\glb \gl{2}-search-\gl{sup} \gl{1}-come-\gl{pfv}//
\glft \qu{I came looking for you.}//
...
\cref{tab:godown} shows all attested cognates, some already discussed, including verb class membership and aligned segments.
While a form \rc{ɨpɨtə} can be reconstructed to \PC, different (proto-)languages do not agree about the class of this verb.
...
These circumstances make it impossible to answer the question of whether it was affected by the extensions in \PTir, \carijo, and \yukpa.
...
It could have been an \gl{s_p_} verb at the time of the extension, it could have been an \gl{s_a_} verb and remained unaffected, or it could have been affected, but with a subsequent erasure of the results by the introduction of \rc{p-}.
For \carijo and \yukpa, we cannot know whether the verb switched verb class before the breakdown of the entire split-\gl{s} system -- this is a plausible scenario especially in the former case.
In all three cases, it is possible that the verb had \gl{s_a_} status at the time of the extension, but it is also possible that it was not even a potential target due to its \gl{s_p_} status.
...
Likewise, the class change must have taken place before the extension of \PPek \rc{k-}, since other scenarios would require an \gl{s_p_} verb taking on regular \gl{s_a_} markers, but selecting the archaic first person marker.
