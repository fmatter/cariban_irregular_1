* [verb_stem_data.csv](data/verb_stem_data.csv.csv)<a name="verb_stem_data">
...
* [split_s_data.csv](data/split_s_data.csv.csv)<a name="split_s_data">
...
* [other_lexemes.csv](data/other_lexemes.csv.csv)<a name="other_lexemes">
...
* [examples.csv](data/examples.csv.csv)<a name="examples">
...
* [extensions.csv](data/extensions.csv.csv)<a name="extensions">
...
* [bathe_data.csv](data/bathe_data.csv.csv)<a name="bathe_data">
...
* [cognate_sets.csv](data/cognate_sets.csv.csv)<a name="cognate_sets">
...
* [languages.csv](data/languages.csv.csv)<a name="languages">
...
* [inflection_data.csv](data/inflection_data.csv.csv)<a name="inflection_data">
