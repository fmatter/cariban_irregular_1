* [verb_stem_data.csv](dataverb_stem_data.csv.csv)<a name="verb_stem_data">
...
* [split_s_data.csv](datasplit_s_data.csv.csv)<a name="split_s_data">
...
* [other_lexemes.csv](dataother_lexemes.csv.csv)<a name="other_lexemes">
...
* [examples.csv](dataexamples.csv.csv)<a name="examples">
...
* [extensions.csv](dataextensions.csv.csv)<a name="extensions">
...
* [bathe_data.csv](databathe_data.csv.csv)<a name="bathe_data">
...
* [cognate_sets.csv](datacognate_sets.csv.csv)<a name="cognate_sets">
...
* [languages.csv](datalanguages.csv.csv)<a name="languages">
...
* [inflection_data.csv](datainflection_data.csv.csv)<a name="inflection_data">
